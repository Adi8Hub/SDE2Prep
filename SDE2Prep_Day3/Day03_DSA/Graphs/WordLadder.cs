...
Console.WriteLine("TODO: Run // TODO: Leetcode 127 - Word Ladder");
string beginWord = "hit", endWord = "cog";
List<string> wordList = ["hot", "dot", "dog", "lot", "log", "cog"];
int ans = Program.LadderLength(beginWord, endWord, wordList);
    ...
    public static int LadderLength(string beginWord, string endWord, IList<string> wordList)
    {
        ...
        while (q.Count > 0)
        {
            ...
            while (size-- > 0)
            {
                ...
                {
                    var originalChar = currWordArr[i];
